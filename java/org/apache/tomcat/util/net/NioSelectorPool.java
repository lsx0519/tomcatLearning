...
public class NioSelectorPool {
    ...
    /**
     * SHARED_SELECTOR赋值Selector.open();
     * @return
     * @throws IOException
     */
    protected Selector getSharedSelector() throws IOException {
        ...
        //sun.nio.ch.WindowsSelectorImpl@13e39c73
    ...
    /**
     * SHARED=true，共用一个selector
     * @throws IOException
     */
    public void open() throws IOException {
        enabled = true;
        //getSharedSelector()对SHARED_SELECTOR赋值，返回SHARED_SELECTOR
        getSharedSelector();
        //SHARED的值org.apache.tomcat.util.net.NioSelectorShared，系统属性没有定义这个，就默认为true
        if (SHARED) {
        	//org.apache.tomcat.util.net.NioBlockingSelector@6a400542
