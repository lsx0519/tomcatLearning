...
public class StandardHost extends ContainerBase implements Host {
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        // Set error report valve ErrorReportValve
        String errorValve = getErrorReportValveClass();
        if ((errorValve != null) && (!errorValve.equals(""))) {
            try {
                boolean found = false;
                //[org.apache.catalina.valves.AccessLogValve[localhost], org.apache.catalina.core.StandardHostValve[localhost]]...
                ...
                if(!found) {
                	//org.apache.catalina.valves.ErrorReportValve[Container is null]
                    Valve valve =
                        (Valve) Class.forName(errorValve).newInstance();
                    //getPipeline:Pipeline[StandardEngine[Catalina].StandardHost[localhost]]
                    //StandardPipeline
