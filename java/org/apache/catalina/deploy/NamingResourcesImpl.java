...
public class NamingResourcesImpl extends LifecycleMBeanBase
    ...
    protected void initInternal() throws LifecycleException {
        ...
        //资源  {UserDatabase=ContextResource[name=UserDatabase, description=User database that can be updated and saved, type=org.apache.catalina.UserDatabase, auth=Container, scope=Shareable]}
