...
public class Http11NioProtocol extends AbstractHttp11JsseProtocol<NioChannel> {
    ...
    public Http11NioProtocol() {
    	//AbstractProtocol中创建Endpoint的实现类NioEndpoint
    	//主要逻辑都来自于你继承的AbstractProtocol
        super(new NioEndpoint());
        Http11ConnectionHandler cHandler = new Http11ConnectionHandler(this);
        setHandler(cHandler);
        //当前协议的NioEndpoint嵌入协议处理责任对象：cHandler
        //意味着接下来，NioEndpoint操作协议连接相关的交给了Http11ConnectionHandler对象，Http11NioProtocol只是一个过度而已
