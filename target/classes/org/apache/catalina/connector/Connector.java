...
public class Connector extends LifecycleMBeanBase  {
    ...
    public Connector(String protocol) {
        ...
        try {
        	//org.apache.coyote.http11.Http11NioProtocol实例化
    ...
    protected void initInternal() throws LifecycleException {
        ...
        //org.apache.coyote.http11.Http11NioProtocol@5af97850
        //Http11NioProtocol插入适配器
        //Http11NioProtocol连接器嵌入适配器，用于container对接
        protocolHandler.setAdapter(adapter);

        // Make sure parseBodyMethodsSet has a default，post请求解释body
        if( null == parseBodyMethodsSet ) {
            setParseBodyMethods(getParseBodyMethods());
        }

        //判断tomcat是否是apr模式-即jni模式
    ...
    protected void startInternal() throws LifecycleException {
        ...
        try {
        	//Http11NioProtocol->父类AbstractProtocol.start()
