...
public class StandardService extends LifecycleMBeanBase implements Service {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        super.initInternal();
        //StandardEngine[Catalina] digester解析实例化的StandardEngine
        //执行StandardEngine.initInternal->ContainerBase启动initInternal，启动线程池
        //先初始化容器
        if (container != null) { 
            container.init();
        }
